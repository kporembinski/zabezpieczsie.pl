    ...
    <>
      <input id="my-drawer-3" type="checkbox" class="drawer-toggle" /> 
        ...
        <div class="flex items-center justify-between w-full">
          <a href="/" class="btn btn-ghost text-xl flex capitalize items-center">
          ...
          <div class="hidden md:flex items-center space-x-4">
            <ul class="menu menu-horizontal px-1">
                  ...
                  <ul class="p-2 bg-base-100 rounded-t-none z-10">
                    {data.value.map((item: Section, index: number) => (
                      <li key={`checklist-nav-${index}`} class={`hover:bg-${item.color}-600 hover:bg-opacity-15`}>
                        <a href={`/checklist/${item.slug}`} class="flex items-center">
              ...
              <li>
                <a href="https://github.com/kporembinski/personal-security-checklist"
                   class="tooltip flex tooltip-bottom items-center" data-tip="Zobacz/edycja źródła i danych">
            ...
            <button
              ...
              class="cursor-pointer tooltip flex tooltip-bottom items-center"
              data-tip="Ustawienia">
