...
export default component$(() => {
  ...
  return (
    <div class="overflow-x-hidden">
      ...
      <div class="navbar bg-base-100 max-w-full overflow-x-hidden">
        <div class="flex-1">
          <a href="/" class="btn btn-ghost text-xl flex capitalize">
            <label htmlFor="my-drawer-3" aria-label="open sidebar" class="tooltip tooltip-bottom" data-tip="Strona główna">
        ...
        <div class="flex-none hidden md:flex">
          <ul class="menu menu-horizontal px-1">
            ...
            <li>
              <a
                href="https://github.com/kporembinski/personal-security-checklist"
                class="tooltip flex tooltip-bottom"
                data-tip="Zobacz/edycja źródła i danych"
              >
          ...
          <div class="tooltip tooltip-bottom" data-tip="Motyw">
            <label class="cursor-pointer grid place-items-center">
              ...
              />
              <svg class="col-start-1 row-start-1 stroke-base-100 fill-base-100" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <circle cx="12" cy="12" r="5" /><path d="M12 1v2M12 21v2M4.2 4.2l1.4 1.4M18.4 18.4l1.4 1.4M1 12h2M21 12h2M4.2 19.8l1.4-1.4M18.4 5.6l1.4-1.4" />
              </svg>
              <svg class="col-start-2 row-start-1 stroke-base-100 fill-base-100" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div class="modal-box">
          ...
          <div class="modal-action justify-start w-full flex flex-col gap-4">
            <div class="flex items-between w-full justify-between">
              <label htmlFor="theme" class="label">Motyw</label>
              <select
                id="theme"
