...
export default component$(() => {
  ...
  <footer class="footer footer-center px-4 py-2 mt-4 text-base-content bg-base-200 bg-opacity-25">
    <aside>
      ...
      © <a href={authorLink} class="link link-primary">Alicia Sykes</a> 2024. Poprawki i tłumaczenie <a href={translatorLink} class="link link-primary">Kamil Porembiński</a> 2026.
